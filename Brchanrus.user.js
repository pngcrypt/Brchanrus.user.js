...
cfg = [
	...
	// Любая доска / тред 
	[/^(mod\.php\?\/|)\w+(\/?$|\/.+\.html)/, [
		['reg', 'div.subtitle > p > a', 'Catálogo', 'Каталог тредов'],
		...
		['txt', 'div.pages > a[href="#all"]', TYPE_FIRSTNODE, 'Все '],
...
var l10n_rus = {
    ...
    "Hello!": "Привет!",
    "{0} users": "{0} users",
    "(hide threads from this board)": "(hide threads from this board)",
    "(show threads from this board)": "(show threads from this board)",
    "No more threads to display": "No more threads to display",
    "Loading...": "Загрузка...",
    "Save as original filename": "Save as original filename",
    "Reported post(s).": "Reported post(s).",
    ...
    "Comment": "Комментарий",
    "Stop watching this thread": "Stop watching this thread",
    "Watch this thread": "Watch this thread",
    ...
    "Image hover on catalog": "Всплывающие изображения в каталоге",
    "Image hover should follow cursor": "Всплывающие изображения следуют за курсором",
    ...
    "(You)": "(Вы)",
    "Use tree view by default": "Use tree view by default",
    ...
    "Enable gallery mode": "Enable gallery mode",
    "Disable gallery mode": "Disable gallery mode",
    ...
    "Enable inlining": "Включить встраивание",
...
// @namespace       https://brchan.org/*
// @author          Y0ba, Isset, pngcrypt
// @updateURL       https://raw.github.com/pngcrypt/Brchanrus.user.js/master/Brchanrus.meta.js
// @run-at          document-start
// @grant           none
// @include         https://brchan.org/*
// @include         http://brchan.org/*
